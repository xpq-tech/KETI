...
class BaseEditor:
    ...
    def __init__(self, hparams: HyperParams):
        ...
        make_logs(f"{self.alg_name}_{self.model_name.split('/')[-1]}_{time_now}.log")
        ...
        self.tok.clean_up_tokenization_spaces = True
    ...
    def batch_edit(self,
        ...
        all_metrics = []
        for record_chunks in _chunks(requests, edit_batch):
            start = time()
